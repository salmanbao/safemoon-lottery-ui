  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            <Text color="white" mb="24px">
              <p>
                The digits on your ticket must <span className="text-color">match in the correct</span> order to win.
                <br />
                <br />
                Here’s an example lottery draw, with two tickets, A and B.
                <br />
                <br />
                <span className="text-color">Ticket A:</span> The first 3 digits and the last 2 digits match, but the
                4th digit is wrong, so this ticket only wins a “Match first 3” prize.
                <br />
                <br />
                <span className="text-color">Ticket B:</span> Even though the last 5 digits match, the first digit is
      ...
      <Flex className="footer-top-section" mt="50px" flexDirection="column">
        <Flex mt="20px" alignItems={['flex-end', null, null, 'center']} justifyContent="center">
          <Flex
            width="100%"
            flexDirection="column"
            ml={[null, null, null, reverse && '0']}
            ...
            <Text color="white" mb="24px">
              <Flex width="100%" flexDirection="column">
                <Flex mb="30px" width="100%" flexDirection="column" justifyContent="space-between">
                  <Flex mb="20px" className="title text-color">
                    Rollover Prizes
                  </Flex>
                  <Flex className="">
                    After every round, if nobody wins in one of the prize brackets, the unclaimed SAFEMOON for that
                ...
                <Flex mb="30px" width="100%" flexDirection="column" justifyContent="space-between">
                  ...
                  <Flex className="">
                    The Burn Pool will go directly to the OFFICIAL SAFEMOON BURN WALLET address. The more we play, the
                    more we burn!
                  </Flex>
                </Flex>
                <Flex mb="30px" width="100%" flexDirection="column" justifyContent="space-between">
                  ...
                  <Flex className="">
                    The funding wallet will help us maintain, improve and innovate this project as well as new projects
                    that we release for the Safemoon community. We will also be using these funds to support new and
                    innovative projects from within the Safemoon community. Please get in touch with your project/MVP
                    here.
                  </Flex>
                </Flex>
              </Flex>
